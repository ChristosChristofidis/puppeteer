...
const extract = require('extract-zip.js');
const util = require('util.js');
const URL = require('url.js');
const {helper} = require('./helper.js');
const removeRecursive = require('rimraf.js');
// @ts-ignore
const ProxyAgent = require('https-proxy-agent.js');
// @ts-ignore
const getProxyForUrl = require('proxy-from-env.js').getProxyForUrl;
